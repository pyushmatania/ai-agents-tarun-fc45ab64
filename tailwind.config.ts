  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        agni: {
          green: "hsl(var(--agni-green))",
          "green-dark": "hsl(var(--agni-green-dark))",
          "green-light": "hsl(var(--agni-green-light))",
          gold: "hsl(var(--agni-gold))",
          "gold-dark": "hsl(var(--agni-gold-dark))",
          red: "hsl(var(--agni-red))",
          blue: "hsl(var(--agni-blue))",
          "blue-dark": "hsl(var(--agni-blue-dark))",
          purple: "hsl(var(--agni-purple))",
          orange: "hsl(var(--agni-orange))",
          pink: "hsl(var(--agni-pink))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
