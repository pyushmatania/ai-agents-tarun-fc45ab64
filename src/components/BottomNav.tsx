  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50">
      <div className="max-w-md mx-auto px-3 pb-2">
        <div className="glass border border-border/40 rounded-2xl px-1 py-1.5 flex items-center justify-around">
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-[8px] font-semibold leading-none ${isActive ? "text-primary" : "text-muted-foreground"}`}>
                  {tab.label}
                </span>
                {isActive && (
