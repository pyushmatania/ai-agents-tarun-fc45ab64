...
const KNOWN_IMAGES: Record<string, string> = {
  ...
  "MS Dhoni": twitterAvatar("msdhoni"),
  "Rohit Sharma": twitterAvatar("ImRo45"),
  "Sachin Tendulkar": twitterAvatar("sachin_rt"),
  ...
  "Carlos Alcaraz": twitterAvatar("carlosalcaraz"),
  "PV Sindhu": twitterAvatar("Pvsindhu1"),
  ...
  "Shreya Ghoshal": twitterAvatar("shreyaghoshal"),
  ...
  "Raftaar": searchAvatar("Raftaar rapper"),
  ...
  "BTS": twitterAvatar("bts_bighit"),
  "BLACKPINK": twitterAvatar("BLACKPINK"),
  "Travis Scott": twitterAvatar("trvisXX"),
  ...
  "Tanmay Bhat": twitterAvatar("tanmaybhat"),
  ...
  "Akshat Shrivastava": searchAvatar("Akshat Shrivastava"),
